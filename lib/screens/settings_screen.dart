        ...
        builder: (context, _) => ListView(
          ...
          children: [
            ...
            _settingsCard([
              ...
              _sliderRow(
                label: 'Arabic',
                sub: 'Duas · Ziyaraat · Arabic text',
                value: _s.arabicFontSize,
                min: 32, max: 72,
                display: '${_s.arabicFontSize.round()}px',
                onChanged: (v) { _s.arabicFontSize = v; _s.save(); },
              ),
            ]),
